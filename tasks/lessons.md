...
- **[verify PRD claims]** Always verify PRD bug analysis against actual code before implementing fixes — PRD Bug 2 claimed spec creates milestones with raw names but code uses `M{N}: {name}` format, causing a reviewer-caught regression
